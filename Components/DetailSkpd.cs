...
{
    public class DetailSkpdViewComponent : ViewComponent
    {
        private readonly DB_NewContext _context;

        public DetailSkpdViewComponent(DB_NewContext context)
        {
            _context = context;
        ...
        {
            var model = _context.Skpd.Include(d => d.IdSptpdNavigation).ThenInclude(d => d.IdCoaNavigation).FirstOrDefault(d => d.IdSkpd == id);
