...
{
    public class DetailSkpdkbtViewComponent : ViewComponent
    {
        private readonly DB_NewContext _context;

        public DetailSkpdkbtViewComponent(DB_NewContext context)
        {
            _context = context;
        ...
        {
            var model = _context.Skpdkbt.Include(d => d.IdSptpdNavigation).ThenInclude(d => d.IdCoaNavigation).FirstOrDefault(d => d.IdSkpdkbt == id);
