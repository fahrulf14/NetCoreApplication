...
{
    public class DetailSptpdViewComponent : ViewComponent
    {
        private readonly DB_NewContext _context;

        public DetailSptpdViewComponent(DB_NewContext context)
        {
            _context = context;
        ...
        {
            var model = _context.Sptpd.Include(d => d.IdCoaNavigation).FirstOrDefault(d => d.IdSptpd == id);
