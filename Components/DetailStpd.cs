...
{
    public class DetailStpdViewComponent : ViewComponent
    {
        private readonly DB_NewContext _context;

        public DetailStpdViewComponent(DB_NewContext context)
        {
            _context = context;
        ...
        {
            var model = _context.Stpd.Include(d => d.IdSkpdNavigation).ThenInclude(d => d.IdSptpdNavigation).ThenInclude(d => d.IdCoaNavigation).FirstOrDefault(d => d.IdStpd == id);
