...
{
    public class TopSideViewComponent : ViewComponent
    {
        ...
        public TopSideViewComponent(BaseApplicationContext context, UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, IHttpContextAccessor httpContextAccessor)
        {
            _appContext = context;
