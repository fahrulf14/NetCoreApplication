...
{
    public class RekapPenerimaanController : Controller
    {
        private readonly DB_NewContext _context;

        public RekapPenerimaanController(DB_NewContext context)
        {
            _context = context;
        }
        ...
        [Auth(new string[] { "Developers", "Laporan" })]
        public ActionResult Cetak(DateTime? tanggal1, DateTime? tanggal2)
        {
            return RedirectToAction("RekapPenerimaan", "Cetak", new { tanggal1, tanggal2 });
        }
    }
}
