...
{
    public partial class PersonalSchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IconClass = table.Column<string>(maxLength: 75, nullable: true),
                    IsParent = table.Column<bool>(nullable: false),
                    ParentId = table.Column<int>(nullable: true),
                    NoUrut = table.Column<int>(nullable: true),
                    FlagAktif = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RF_Position", x => x.Id);
                });
